...
- Link the output image folder.
- Link the contact sheet.
- Link the outline and talk script.
- Mention any residual issues, especially AI-generated text that should be reviewed manually.
